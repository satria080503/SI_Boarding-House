<style>
  ...
  <nav class="navbar navbar-bottom navbar-dark bg-dark navbar-expand d-lg-none d-xl-none fixed-bottom">
    <ul class="navbar-nav nav-justified w-100">
      ...
      <li class="nav-item">
        <a href="<?php echo e(url('show-all-room')); ?>" class="nav-link text-white"><i class="feather icon-calendar"></i>Booking</a></a>
      </li>
      <li class="nav-item">
...
<?php /**PATH C:\xampp\htdocs\papikos\resources\views/layouts/front/menuBottom.blade.php ENDPATH**/ ?>