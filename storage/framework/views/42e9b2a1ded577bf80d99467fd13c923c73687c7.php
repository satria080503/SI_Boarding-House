...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/pages/authentication.css')); ?>">
    <!-- END: Page CSS-->
...
<body class="horizontal-layout horizontal-menu 1-column  navbar-floating footer-static bg-full-screen-image  blank-page blank-page" data-open="hover" data-menu="horizontal-menu" data-col="1-column">
                  ...
                  <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                    <img src="<?php echo e(asset('assets/images/pages/login.png')); ?>" alt="branding logo">
                                </div>
    ...
    <script src="<?php echo e(asset('assets/vendors/js/ui/jquery.sticky.js')); ?>"></script>
    <!-- END: Page Vendor JS-->

    <!-- BEGIN: Theme JS-->
    <script src="<?php echo e(asset('assets/js/core/app-menu.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/core/app.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/scripts/components.js')); ?>"></script>
    <!-- END: Theme JS-->
...
</html><?php /**PATH C:\xampp\htdocs\papikos\resources\views/layouts/auth.blade.php ENDPATH**/ ?>