...
<?php else: ?>
  <div class="card-btn d-flex justify-content-between mt-2">
    ...
    <?php if($kamar->total() >= 8): ?>
    <a href="<?php echo e(url('show-all-room')); ?>" class="btn btn-outline-info mb-1" style="color:black">Lihat Semua</a>
    <?php endif; ?>
  </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\papikos\resources\views/front/cardContent.blade.php ENDPATH**/ ?>